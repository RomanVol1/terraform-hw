...
1. Образ docker nginx:latest не был удален, поскольку атрибуту keep_locally было присвоено значение true в конфигурации terraform для ресурса docker_image. Этот параметр сообщает terraform сохранять образ локально, даже после уничтожения ресурса.
------
